...
頻繁に購入される商品、たまに買われる商品、普段買わない新しい発見があるような商品をバランス良く含めてください。
提案は商品名を箇条書きで10個ほど列挙してください。それらを提案した理由は不要です。
また最後に、それらを使用した献立を可能であれば2~3個ほど出力してください。定番だけでなく、少し意外性のある商品も混ぜてください。
出力はマークダウン形式にしてください。
"""
